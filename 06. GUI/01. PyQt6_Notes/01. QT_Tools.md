...
📌 Main Window (QMainWindow)
  📌 centralwidget(QW, ▌▌▌, Layout(M-0,P-0))
    |▶ IconMenuContainer (QW, ☰, LA-Left, Max-W->80 , Min-W->0) (1 -> )
    | | |▶ ... Same like Menu container ...
    |▶ MenuContainer (QW, ☰, LA-Left, Max-W->200) (1 -> )
    | |▶ SubMenuContainer (QW, ☰, LA-No , Min-W->0)
    | | |▶ logo_frame (QF, ☰, -> LA-Top, Layout(M-0,P-0) )
    | | | |▶ logo (QL, Pixmap -> logo.png, Min-W 40, Min-H 40)
    | | |▶ top (QF, ☰, -> LA-Top, Layout(M-0,P-0) )
    ...
    | | |▶ verticalSpacer (||||||||||)
    | | |▶ bottom (QF, ☰ -> LA-Bottom, Layout(M-0,P-0) )
