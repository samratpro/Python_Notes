...
📌 Main Window (QMainWindow)
  📌 centralwidget(QW, ▌▌▌, Layout(M-0,P-0))
    |▶ IconMenuContainer (QW, ☰, LA-Left, Max-W->50 , Min-W->0) (`Order -> 1`)
    | | |▶ ... Same like Menu container ... (`Order -> 2, ...`)
    |▶ MenuContainer (QW, ☰, LA-Left, Max-W->150) (Order -> 1)
    | |▶ SubMenuContainer (QW, ☰, LA-No , Min-W->0) (Order -> 2)
    | | |▶ logo_frame (QF, ☰, -> LA-Top, Layout(M-0,P-0) ) (`Order -> 3`)
    | | | |▶ logo (QL, Pixmap -> logo.png, Min-W 40, Min-H 40)
    | | |▶ top (QF, ☰, -> LA-Top, Layout(M-0,P-0) ) (`Order -> 3`)
    ...
    | | |▶ verticalSpacer (||||||||||)
    | | |▶ bottom (QF, ☰ -> LA-Bottom, Layout(M-0,P-0) ) (Order -> 3)
    ...
    |▶ mainBodyContainer (☰, LA-No, Layout(M-0,P-0), (`Order -> 1`))
    | | |▶ subBodyContainer (Layout(M-0,P-0), Order -> 2)
