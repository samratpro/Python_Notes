...
### Terminal Base Runs
```
sudo chown -R www:www /www/wwwroot/service_site/2cb907f_venv
sudo chmod 755 /www/wwwroot/service_site/2cbf0ae_venv/bin/python3
sudo chmod 755 /www/wwwroot/service_site/2cbf0aeb09dbe18b935ec5608d72907f_venv/bin/*
sudo chmod 644 /www/wwwroot/service_site/manage.py
sudo -u www /www/wwwroot/service_site/2cb7f_venv/bin/python3 manage.py migrate
ps aux | grep gunicorn # check status
nohup sudo -u www /www/wwwroot/service_site/2cbf0aeb09dbe18b935ec5608d72907f_venv/bin/gunicorn --bind 127.0.0.1:8000 core.wsgi:application > /tmp/gunicorn.log 2>&1 &
```
